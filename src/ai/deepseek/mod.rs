...
> {
    ...
    let table_selection_prompt = format!(
        ...
        **重要匹配规则**:
        1. 优先匹配包含用户描述中年份的表格（例如描述'2026年01月新番'应优先匹配包含'2026年'的表格）
        2. 月份对应关系：
           - 01月、02月、03月 → 冬季（冬），表格标题通常显示为'2026年 冬(1月～) 放送開始予定作品'
           - 04月、05月、06月 → 春季（春），表格标题通常显示为'2026年 春(4月～) 放送開始予定作品'
           - 07月、08月、09月 → 夏季（夏），表格标题通常显示为'2026年 夏(7月～) 放送開始予定作品'
           - 10月、11月、12月 → 秋季（秋），表格标题通常显示为'2026年 秋(10月～) 放送開始予定作品'
        3. 表格标题格式说明：
           - '2026年 冬(1月～) 放送開始予定作品' 表示2026年冬季（1月开始的）作品
           - '2025年 12月～ 放送開始予定作品' 表示2025年12月开始的作品（属于2025年冬季）
        4. 具体示例：
           - '2026年01月新番' 应匹配 '2026年 冬(1月～) 放送開始予定作品'
           - '2026年04月新番' 应匹配 '2026年 春(4月～) 放送開始予定作品'
           - '2025年12月新番' 应匹配 '2025年 12月～ 放送開始予定作品'（如果存在）
        5. 即使描述是简写如'2601'，也应理解为'2026年01月'
        \n\n
